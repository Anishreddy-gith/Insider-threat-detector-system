"""
End-to-end inference pipeline (v2 — four-detector ensemble).

Orchestrates:
    feature vector → IsolationForest + Autoencoder + LSTM + GNN → Ensemble → XAI
...
class InferencePipeline:
    ...
    async def predict_single(
        ...
        # ── Autoencoder (distributional anomaly) ─────────────────────
