"""
Flower server — FedAvg aggregation strategy for the ITDS autoencoder.
...
from app.privacy.federated.client import _FederatedAutoencoder
...
class ITDSFedAvgStrategy(FedAvg):
    ...
    num_rounds : int
        Total federated rounds (informational — actual count is in
        ``ServerConfig``).
    """
    ...
    # ── Override: log per-round metrics ─────────────────────────────
