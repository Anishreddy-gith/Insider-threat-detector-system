"""
federated – Flower-based federated learning for the ITDS autoencoder.
...
Strategy: **FedAvg** (McMahan et al., 2017) — each client trains for
``local_epochs`` steps, then sends updated weights.  The server
averages them proportional to dataset size.
"""

from app.privacy.federated.client import ITDSFlowerClient, make_client_fn
from app.privacy.federated.server import (
    ITDSFedAvgStrategy,
