...
GDPR Article 35:
    ...
    1. Data Collected
    2. Retention Periods
    3. Îµ Budget & Differential Privacy
    4. Data Minimisation Measures
    5. User / Data Subject Rights
    6. Risk Mitigations

The report is deterministic for a given configuration â€” it reads
...
def generate_pia(
    *,
    ...
    Returns
    -------
    dict â€” The full PIA report, serialisable to JSON.
    """
...
# â”€â”€ Section builders â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _section_retention() -> dict[str, Any]:
    return {
        ...
        "model_weights": {
            ...
            "justification": (
                "Trained models contain no raw PII â€” only statistical "
        ...
        "anomaly_alerts": {
            ...
            "deletion_method": "Annual archival â†’ encrypted cold storage â†’ 7-year purge",
        },
...
def _section_privacy_budget(settings: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "guarantee_summary": (
            f"Each query consumes Îµ from the entity's daily budget. "
            f"The total guarantee degrades linearly: k queries of Îµ each "
            f"yield (kÂ·Îµ)-DP. Budget resets every 24 hours."
        ),
    ...
    mitigations = [
        {
            ...
            "mitigation": (
                f"Differential privacy (Îµ={settings.DP_EPSILON}) bounds "
        ...
        },
        {
            ...
            "mitigation": (
                f"(Îµ={settings.DP_EPSILON}, Î´={settings.DP_DELTA})-DP "
                f"makes membership inference probabilistically bounded "
                f"to at most e^Îµ â‰ˆ {math.exp(settings.DP_EPSILON):.2f}Ã— "
                f"advantage."
            ),
            "residual_risk": "low",
        },
        ...
        },
        {
            ...
            "description": (
                "An attacker intentionally exhausts an entity's Îµ budget "
...
# â”€â”€ Convenience class â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
