...
Best for: **volumetric / distributional anomalies** â€” detecting when a
user's *overall behavioural profile* deviates from their personal
baseline (e.g. a finance analyst whose file-access volume jumps 10Ã—
while their login pattern stays normal).

Architecture
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    Encoder:  32 â†’ 16 â†’ 8  (bottleneck)
    Decoder:   8 â†’ 16 â†’ 32 (reconstruction)
...
the user's training-set error distribution; anything > 2Ïƒ above the
...
class _Autoencoder(nn.Module):
    """Symmetric feed-forward autoencoder: 32 â†’ 16 â†’ 8 â†’ 16 â†’ 32."""
    ...
    def __init__(self, input_dim: int = 32) -> None:
        ...
        self.decoder = nn.Sequential(
            ...
            # No activation â€” reconstruction targets are real-valued
        )
...
class AutoencoderDetector(BaseDetector):
    ...
    def predict(self, X: np.ndarray) -> list[dict[str, Any]]:
        """
        Compute reconstruction error and flag anomalies > 2Ïƒ.
        """
