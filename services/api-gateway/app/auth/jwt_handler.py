...
Design decisions
----------------
* **HS256 symmetric signing** — acceptable for a single-gateway topology
...
* **Role embedded in payload** — so the gateway can enforce RBAC without a
  ...
  staleness window.
* **Separate refresh token** — long-lived (7 days), used only to obtain
