...
from app.models.database import Alert, MonitoredEntity, get_db
...
from app.services.service_client import aggregate_dashboard, proxy_get
...
async def model_health(
    ...
    """
    from app.services.service_client import _safe_get_factory
    import asyncio
...
async def update_thresholds(
    ...
    from httpx import HTTPStatusError
    from app.services.service_client import proxy_post
    try:
