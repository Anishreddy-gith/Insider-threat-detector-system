...
Why per-role?
  â€¢ **HR_SYSTEM** accounts push bulk employment data â€” they should be
    heavily throttled (30 req/min) to prevent a compromised HR connector
    from flooding the gateway.
  â€¢ **SOC_ANALYST** dashboards poll frequently â€” 120 req/min is generous
    but avoids runaway browser tabs from overwhelming the backend.
  â€¢ **ADMIN** accounts may run batch operations â€” 300 req/min.
  â€¢ Unauthenticated (anonymous) traffic gets the default cap (60 req/min)
    applied by IP.
...
class RateLimiterMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        # Determine role + identifier â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # Fixed-window counter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
