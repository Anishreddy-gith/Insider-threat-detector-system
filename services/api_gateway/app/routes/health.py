...
``/health``       â†’ lightweight liveness (is the gateway process alive?)
``/health/ready`` â†’ deep readiness (PG + Redis + all downstream services)
"""
...
from services.api_gateway.app.models.database import engine
