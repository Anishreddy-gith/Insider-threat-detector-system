...
async def lifespan(application: FastAPI):
    """Startup / shutdown hooks – mirrors the pattern in all other services."""
...
# ── Routes ───────────────────────────────────────────────────────────────
from app.routes import auth as auth_routes  # noqa: E402 – after app init
